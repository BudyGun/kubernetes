...
```
Чтобы сформировать данную команду - нужно сначало сфгенерировать новый токен на мастер узле, а затем сгенерировать команду подключения на мастер узле. Полученную команду скопировать и запустить на рабочем узле. 
